...
public class ClientApplication {
  ...
  public ClientApplication() {
   ...
   // frame.paint(new MyGraphics());
    ...
    RepaintManager.currentManager(login).setDoubleBufferingEnabled(false);
    login.paint(new CanvaGraphic().create());
    RepaintManager.currentManager(login).setDoubleBufferingEnabled(true);
    //login.add(slider);
