...
public class EXHorizontalLayoutContainer extends EXVerticalLayoutContainer implements LayoutContainer {

	public EXHorizontalLayoutContainer() {
		super("EXRowLayoutContainer");
	}

	public EXHorizontalLayoutContainer(String name) {
		super(name);
	}
