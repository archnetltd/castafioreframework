...
public @interface Field {
	...
	/**
	 * the class type to be instantated for the field
	 * The class type should be an instance of StateFullComponent
	 * and also should have a constructor with single parameter as the name
	 * @return
	 */
	public Class fieldType() default EXInput.class;
	
	/**
	 * used to provide list data for select components
	 * Class should be instance of list provider
	 * @return
	 */
