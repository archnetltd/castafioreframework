package org.castafiore.ui.svg.gradient;
...
import org.castafiore.ui.svg.values.Transformation;
...
public class SVGRadialGradient extends SVGContainer implements PresentationAttributeAble,XLinkAttributeAble{

	public SVGRadialGradient(String name) {
		super(name, "radialGradient");
	}

	
	public UnitValues getGradientUnits() {
		return UnitValues.valueOf(getAttribute("gradientUnits"));
	}

	public void setGradientUnits(UnitValues gradientUnits) {
		setAttribute("gradientUnits", gradientUnits.toString());
	}

	public Transformation getGradientTransform() {
		return Transformation.valueOf(getAttribute("gradientTransform"));
	}

	public void setGradientTransform(Transformation gradientTransform) {
		setAttribute("gradientTransform", gradientTransform.toString());
	}

	public Point getCenter() {
		return new Point( Integer.parseInt(getAttribute("cx")), Integer.parseInt(getAttribute("cy")));
	}

	public void setCenter(Point start) {
		setAttribute("cx", start.x + "");
		setAttribute("cy", start.y + "");
	}

	public Point getFunctionPoint() {
		return new Point( Integer.parseInt(getAttribute("fx")), Integer.parseInt(getAttribute("fy")));
	}

	public void setFunctionPoint(Point end) {
		setAttribute("fx", end.x + "");
		setAttribute("fy", end.y + "");
	}

	public String getSpreadMethod() {
		return getAttribute("spreadMethod");
	}

	public void setSpreadMethod(String spreadMethod) {
		setAttribute("this.spreadMethod", spreadMethod);
	}
