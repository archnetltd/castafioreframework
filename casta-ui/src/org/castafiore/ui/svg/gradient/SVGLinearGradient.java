...
public class SVGLinearGradient extends SVGContainer implements PresentationAttributeAble,XLinkAttributeAble{

	
	public SVGLinearGradient(String name) {
		super(name, "linearGradient");
	}
	...
	public Point getStart() {
		return new Point( Integer.parseInt(getAttribute("x1")), Integer.parseInt(getAttribute("y1")));
	}
	...
	public Point getEnd() {
		return new Point( Integer.parseInt(getAttribute("x2")), Integer.parseInt(getAttribute("y2")));
	}
