...
import org.castafiore.ui.svg.values.Values.MarkerUnitValues;
...
public class SVGMarker extends SVGContainer implements PresentationAttributeAble{
	...
	public SVGMarker(String name) {
		super(name, "marker");
		
	}
	
	public MarkerUnitValues getMarkerUnits(){
		return MarkerUnitValues.valueOf(getAttribute("markerUnits"));
	}
	
	public void setMarkerUnits(MarkerUnitValues val){
		setAttribute("markerUnits", val.toString());
	}
	
	public void setRef(Point p){
		setAttribute("refX", p.x + "");
		setAttribute("refY", p.y + "");
	}
	
	public Dimension getMarkerWidth(){
		return Dimension.parse(getAttribute("markerWidth"));
	}
	
	public void setMarkerWidth(Dimension d){
		setAttribute("markerWidth", d.toString());
	}
	
	public Dimension getMarkerHeight(){
		return Dimension.parse(getAttribute("markerHeight"));
	}
	
	public void setMarkerHeight(Dimension d){
		setAttribute("markerHeight", d.toString());
	}
	
	public Point getRef(){
		return new Point(Integer.parseInt(getAttribute("refX")), Integer.parseInt(getAttribute("refY")));
	}
	...
	public void setOrient(String s){
		setAttribute("orient", s);
	}
	...
	public void setViewBox(String s){
		setAttribute("viewBox", s);
	}
	
	public Transformation getTransformation(){
		return Transformation.valueOf(getAttribute("transform"));
	}
