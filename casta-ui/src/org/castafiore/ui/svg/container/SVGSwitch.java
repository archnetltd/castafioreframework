...
public class SVGSwitch extends SVGContainer implements ConditionalProcessingAttributeAble,PresentationAttributeAble {

	public SVGSwitch(String name) {
		super(name, "switch");
	}
	...
	public String getAllowReorder(){
		return getAttribute("allowReorder");
	}
	public void setAllowReorder(String s){
		setAttribute("allowReorder",s);
	}
