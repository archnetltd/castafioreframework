...
public class Svg extends SVGContainer implements ConditionalProcessingAttributeAble,PresentationAttributeAble{
	...
	public void setContentScriptType(String v){
		setAttribute("contentScriptType", v);
	}
	...
	public String getZoomAndPan(){
		return getAttribute("zoomAndPan");
	}
	
	public void setZoomAndPan(String v){
		setAttribute("zoomAndPan", v);
	}
	
	public void setContentStyleType(String v){
		setAttribute("contentStyleType", v);
	}
	...
	public String getBaseProfile(){
		return getAttribute("baseProfile");
	}
	
	public void setBaseProfile(String v){
		setAttribute("baseProfile", v);
	}
