...
public class SVGA extends SVGContainer implements ConditionalProcessingAttributeAble,PresentationAttributeAble,XLinkAttributeAble{

	public SVGA(String name) {
		super(name, "a");
