...
public class SVGCircle extends SVGContainer implements ConditionalProcessingAttributeAble,PresentationAttributeAble {

	public SVGCircle(String name, int radius) {
		super(name, "circle");
		setRadius(radius);
	}
	...
	protected SVGCircle(String name, String tagName, int radius) {
		super(name, tagName);
		setRadius(radius);
	}
	...
	public SVGCircle(String name, int radius, Point center) {
		super(name, "circle");
		setRadius(radius);
		setCenter(center);
	}
	
	public SVGCircle setRadius(int radius){
		setAttribute("r", radius + "");
		return this;
	}
	
	public int getRadius(){
		return Integer.parseInt(getAttribute("r"));
	}
	...
	public SVGCircle setCenter(Point point){
		setAttribute("cy", point.getY() + "");
		setAttribute("cx", point.getX() + "");
		return this;
	}
