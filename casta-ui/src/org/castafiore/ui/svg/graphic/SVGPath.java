package org.castafiore.ui.svg.graphic;
...
public class SVGPath extends SVGContainer implements ConditionalProcessingAttributeAble,PresentationAttributeAble{

	public SVGPath(String name) {
		super(name, "path");
		
	}
	
	protected SVGPath(String name, String tag) {
		super(name, tag);
		
	}
	
	protected void append(String command,Point p){
		String d = getAttribute("d");
		if(StringUtil.isNotEmpty(d)){
			d="";
		}
		
		d = d + " " + command + p.getX() + " " + p.getY();
		setAttribute("d", d.trim());
	}
	
	public SVGPath moveTo(Point p){
		append("M", p);
		return this;
	}
	
	public SVGPath lineTo(Point p){
		append("L", p);
		return this;
	}
	
	public SVGPath horizontalLineTo(Point p){
		append("H", p);
		return this;
	}
	
	public SVGPath verticalLineTo(Point p){
		append("V", p);
		return this;
	}
	
	public SVGPath curveTo(Point p){
		append("C", p);
		return this;
	}
	
	public SVGPath smoothCurveTo(Point p){
		append("S", p);
		return this;
	}
	
	public SVGPath quadraticBezierCurveTo(Point p){
		append("Q", p);
		return this;
	}
	
	public SVGPath smoothQuadraticBezierCurveTo(Point p){
		append("T", p);
		return this;
	}
	
	public SVGPath ellipticalArcTo(Point p){
		append("A", p);
		return this;
	}
