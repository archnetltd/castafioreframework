...
public class SVGPolyline extends SVGContainer implements ConditionalProcessingAttributeAble,PresentationAttributeAble{

	public SVGPolyline(String name) {
		super(name, "polyline");
	}
	
	public SVGPolyline setPoints(Point...points){
		String p = "";
		for(Point pp : points){
