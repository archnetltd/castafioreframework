...
public class SVGRect extends SVGContainer implements ConditionalProcessingAttributeAble,PresentationAttributeAble{

	public SVGRect(String name, Point start, int width, int height) {
		super(name, "rect");
		
	}
	public SVGRect(String name, Point start, int width, int height, int cornerRadius) {
		super(name, "rect");
	...
	public SVGRect setCorner(Point point){
