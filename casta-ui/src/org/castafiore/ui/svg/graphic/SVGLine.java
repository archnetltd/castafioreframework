...
public class SVGLine extends SVGContainer implements ConditionalProcessingAttributeAble,PresentationAttributeAble{

	public SVGLine(String name, Point start, Point end) {
		super(name, "line");
		setStart(start).setEnd(end);
	}
	
	public SVGLine setStart(Point start){
		setAttribute("x1", start.getX() + "");
		setAttribute("y1", start.getY() + "");
		return this;
	}
	
	
	public SVGLine setEnd(Point end){
		setAttribute("x2", end.getX() + "");
		setAttribute("y2", end.getY() + "");
		return this;
	}
