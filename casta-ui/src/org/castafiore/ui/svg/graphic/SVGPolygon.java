...
public class SVGPolygon extends SVGContainer implements ConditionalProcessingAttributeAble,PresentationAttributeAble {

	public SVGPolygon(String name) {
		super(name, "polygon");

	}
	
	public SVGPolygon setPoints(Point...points){
		String p = "";
		for(Point pp : points){
