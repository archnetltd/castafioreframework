...
public class SVGPattern extends SVGContainer implements PresentationAttributeAble, ConditionalProcessingAttributeAble,XLinkAttributeAble {



	public SVGPattern(String name) {
		super(name, "pattern");

	}

	public String getPatternUnits() {
		return getAttribute("patternUnits");
	}

	public void setPatternUnits(String patternUnits) {
		setAttribute("patternUnits", patternUnits);
	}

	public String getPatternContentUnits() {
		return getAttribute("patternContentUnits");
	}

	public void setPatternContentUnits(String patternContentUnits) {
		setAttribute("patternContentUnits", patternContentUnits);
	}

	public String getPatternTransform() {
		return getAttribute("patternTransform");
	}

	public void setPatternTransform(String patternTransform) {
		setAttribute("patternTransform", patternTransform);
	}
