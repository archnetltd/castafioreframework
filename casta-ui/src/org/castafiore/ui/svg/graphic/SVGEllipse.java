...
public class SVGEllipse extends SVGContainer implements ConditionalProcessingAttributeAble,PresentationAttributeAble{

	public SVGEllipse(String name, int hRadius, int vRadius) {
		super(name, "ellipse");
		setVerticalRadius(vRadius);
		setHorizontalRadius(hRadius);
	}
	
	public SVGEllipse setVerticalRadius(int vRadius){
		setAttribute("ry", vRadius + "");
		return this;
	}
	
	public SVGEllipse setHorizontalRadius(int hRadius){
		setAttribute("rx", hRadius + "");
		return this;
	}
	
	public Point getCenter(){
		try{
			Point p = new Point(Integer.parseInt("cx"), Integer.parseInt("cy"));
			return p;
		}catch(Exception e){
			return null;
		}
	...
	public SVGEllipse setCenter(Point point){
		setAttribute("cy", point.getY() + "");
		setAttribute("cy", point.getX() + "");
		return this;
	}
