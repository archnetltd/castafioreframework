...
public class SVGUse extends SVGContainer implements ConditionalProcessingAttributeAble,PresentationAttributeAble, XLinkAttributeAble{

	
	public SVGUse(String name) {
		super(name, "use");
	}
