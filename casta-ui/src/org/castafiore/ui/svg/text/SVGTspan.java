...
public class SVGTspan extends SVGContainer implements PresentationAttributeAble, ConditionalProcessingAttributeAble,XLinkAttributeAble{

	public SVGTspan(String name) {
		super(name, "tspan");
	}
