...
public class SVGTref extends SVGContainer implements PresentationAttributeAble, ConditionalProcessingAttributeAble,XLinkAttributeAble{

	public SVGTref(String name) {
		super(name, "tref");
	}
