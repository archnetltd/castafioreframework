...
public class SVGAltGlyph extends SVGContainer implements PresentationAttributeAble, ConditionalProcessingAttributeAble,XLinkAttributeAble {

	public SVGAltGlyph(String name) {
		super(name, "algGlyph");
	}
