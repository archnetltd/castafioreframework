package org.castafiore.ui.svg.text;
...
public class SVGTextPath extends SVGContainer implements PresentationAttributeAble, ConditionalProcessingAttributeAble,XLinkAttributeAble{

	public SVGTextPath(String name) {
		super(name, "textPath");
	}
