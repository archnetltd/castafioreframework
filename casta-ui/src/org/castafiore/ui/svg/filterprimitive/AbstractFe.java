...
public class AbstractFe extends SVGContainer implements PresentationAttributeAble,FilterPrimitiveAttributeAble{
	
	public AbstractFe(String name, String tagName) {
		super(name, tagName);
	}


	public String getIn() {
		return getAttribute("in");
	}
	...
	@Override
	public Point getXY() {
		return new Point(Integer.parseInt(getAttribute("x")), Integer.parseInt(getAttribute("y")) );
	}
	...
	public void setXY(Point xy) {
		setAttribute("x", xy.getX() + "");
		setAttribute("y", xy.getY() + "");
