...
/**
 * Extends {@link HTMLTag} to add DHTML features to it. i.e. Ability to add
 * events
 * 
 * @see DynamicHTMLTag
 ...
 */
public abstract class EXDynamicHTMLTag extends EXHtmlTag implements
		DynamicHTMLTag, Container {
	/**
	 * 
	 */
