...
public class EXOverlayPopupPlaceHolder extends EXContainer {
	...
	public EXOverlayPopupPlaceHolder(String name) {
		super(name, "div");
		setStyle("display", "none").setStyle("width", "100%")
				.setStyle("height", "100%").setStyle("opacity", "0.75")
				.setStyle("background-color", "black")
				.setStyle("position", "fixed").setStyle("top", "0")
				.setStyle("left", "0").setStyle("z-index", "3000");
	}
	...
	public Container addChild(Container c) {
		...
		c.setStyle("position", "absolute").setStyle("top", new Var(vert))
				.setStyle("left", new Var(script));
		return this;
	}
