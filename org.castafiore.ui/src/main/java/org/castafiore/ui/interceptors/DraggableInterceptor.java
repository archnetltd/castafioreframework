 ...
 * The programmer simply need to make his component implement {@link Draggable}.
 * This interceptor will be used under the hood to add the functionalities
 * 
...
public class DraggableInterceptor implements Interceptor {
	...
	public void handleDraggable(Draggable container) {
		...
		if (!hasDraggable) {
			container.addEvent(
					new AdvancedDraggableEvent((Draggable) container),
					Event.READY);
		}
	}
}
