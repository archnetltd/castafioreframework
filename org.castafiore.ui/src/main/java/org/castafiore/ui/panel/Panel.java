...
/**
 * 
 * A common interface for different implementation of a panel. A good idea to
 * orient implementation towards interface design instead of concrete
 * implementation.
 * 
 * User can have his own implementation of a panel and plug into existing
 * components.
 * 
