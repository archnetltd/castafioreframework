...
public class Dimension {
	...
	/**
	 * Creates a {@link Dimension} based on a string representation that can be
	 * parsed
	 * 
	 * @param userDefined
	 *            The userdefined string
	 */
	...
	/**
	 * Creates a {@link Dimension} by parsing a string representation of a
	 * dimension
	 * 
	 * @param dimension
	 ...
	 * 
	 * @param amount
	 *            The scalar value of the dimension
	 */
	...
	/**
	 * Converts the {@link Dimension} into a string representation to be
