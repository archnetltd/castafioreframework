...
/**
 * 
 * Layout of each cell of a table is delegated to implementations of this
 * interface
 * 
...
public interface CellRenderer extends Serializable {
	 ...
	 * @param page
	 *            The page of the table if the table is paginable
	 * @param model
	 *            The model applied on the table
	 * @param table
	 *            The table itself
	 * @return The container to display in the table for the specified row,
	 *         column and page
	 */
	...
	/**
	 * Changes the content of anything of the container for the specified cell
