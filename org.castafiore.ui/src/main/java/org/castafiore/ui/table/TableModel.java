...
public interface TableModel extends Serializable {
	...
	/**
	 * Returns the number of rows in the model. A <code>EXTable</code> uses this
	 ...
	 * @return The value to place in the specified cell. This value will be
	 *         passed via the {@link CellRenderer}
	 */
	public Object getValueAt(int col, int row, int page);

	/**
	 * The default class for values in the specified column.<br>
	 * Can be used as an indicated to choose the correct container to provide in
	 * the {@link CellRenderer}
	 * 
	 * @param columnIndex
	...
	/**
	 * States whether the specified row and column is editable<br>
	 * Can be used as an indicated to choose the correct container to provide in
	 * the {@link CellRenderer}
	 * 
	 * @param rowIndex
