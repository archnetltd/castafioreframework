...
public class DirectoryConfig extends AbstractFileConfig{
	...
	public File getNewInstance() {
		...
		return service.getDirectory(getParentDir(), service.getSuperUser()).createFile(getName(), Directory.class);
