...
public class EXAttachementEditor extends EXContainer implements EditableCellRenderer, EditableTableModel, Event, ArticleEditorTab{
	
	private String [] labels = new String[]{"Attachement", "Remove"};
	
	private List<BinaryFile> attachements = new ArrayList<BinaryFile>();

	public EXAttachementEditor(String name) {
		super(name,"div");
	...
	public void fill(Article art){
		...
		attachements = art.getAttachments().toList();
	}
