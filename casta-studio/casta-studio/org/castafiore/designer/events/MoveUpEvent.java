...
public class MoveUpEvent implements Event{
	...
	public boolean ServerAction(Container container,
		...
		if(cont instanceof DesignableLayoutContainer){
			cont.getParent().getAncestorOfType(DesignableLayoutContainer.class).moveUp(cont);
		}else{
			cont.getAncestorOfType(DesignableLayoutContainer.class).moveUp(cont);
		}
