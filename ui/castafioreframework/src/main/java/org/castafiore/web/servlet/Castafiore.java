...
public class Castafiore implements ApplicationContextAware {
	...
	protected void error(HttpServletRequest request, HttpServletResponse response, Exception e)throws Exception{
	...
	@RequestMapping("/ui")
	public void doServlet(HttpServletRequest request, HttpServletResponse response)throws Exception{
	...
	public void doResource(@PathVariable("spec")String spec, HttpServletRequest request, HttpServletResponse response)throws Exception{
		pre(request,response);
		try{
			ResourceLocator locator = (ResourceLocator)context_.getBean("resourcelocator_" + spec);
	...
	public void doService(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ComponentUtil.loadApplication((HttpServletRequest)request, (HttpServletResponse)response, context_);
