...
public class EXMutableIdLayoutContainer extends EXMutableIdContainer implements LayoutContainer {

	public EXMutableIdLayoutContainer(String name, String tagName, String id) {
		super(name, tagName, id);
