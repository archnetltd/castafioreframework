...
public class EXXYLayoutContainer extends EXContainer implements LayoutContainer {

	public EXXYLayoutContainer(String name, String tagName) {
		super(name, tagName);
	}
	
	public EXXYLayoutContainer(String name) {
		super(name, "div");
	}

	public EXXYLayoutContainer() {
