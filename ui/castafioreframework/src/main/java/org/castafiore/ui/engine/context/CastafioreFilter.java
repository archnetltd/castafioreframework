...
/**
 * This interface acts as a Filter to be used exclusively in Castafiore framework.
 * 
 * It is configured inside a spring application context.
 * 
 * The order in which Filters are executed are not granteed. But depends on how the spring application context serves the implementations of this interface
 * @author kureem
 *
 */
